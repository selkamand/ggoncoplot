...
-   **Support for tidy datasets**: Compatibility with tidy, tabular mutation-level formats that      cancer cohort datasets are typically stored in, for example in Mutation Annotation Format        (MAF) files or relational databases. This greatly improves the range of datasets that can be      quickly and easily visualised in an oncoplot.
