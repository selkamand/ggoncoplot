...
knitr::opts_chunk$set(
  ...
  out.width = "100%",
  dev       = "ragg_png",   # high-quality raster device
  dpi       = 300,          # base pixel density
  fig.retina= 2            # 2x pixels for HiDPI (GitHub will downscale)
)
```
...
Alternatively, install the development version of ggoncoplot from github:
...
challenges together. Examples of all key
...
If using ggoncoplot, please cite this [2025 JOSS paper](https://doi.org/10.21105/joss.07390)
