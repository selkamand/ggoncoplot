...
ggoncoplot <- brca_df |>
  ggoncoplot(
    ...
    options = ggoncoplot_options(
      show_genebar_labels = TRUE, plotsize_metadata_rel_height = 30, plotsize_tmb_rel_height = 10, 
      genebar_label_nudge = 20, show_legend = FALSE
    ),
    interactive = FALSE,
    verbose=FALSE
  )
...
combined_plots <- (tsne_expression + umap_methylation) / ggoncoplot  + plot_layout(heights = c(4, 6))
