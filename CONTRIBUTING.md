...
5.  **Test Package**: Run `devtools::test()` and `devtools::check()` to
    ensure changes do not break other behaviours. Add additional unit
    tests to cover new behaviour.

6.  **Commit and Push**: Commit your changes and push the branch to your
    forked repository.

7.  **Create a Pull Request**: Go to the original repository and open a
